...
import { css, finish, finishFrame, shortcut } from "@/monzon/src/lib/utils";
import { getTopWindow, liftMirror, mountWindow, openedWindows, useDesktop } from "@/monzon/src/ui/desktop.ts";
...
import { NumberInput } from "@/monzon/src/ui/number-input";
