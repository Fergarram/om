...
function create_game(config) {
    ...
    function create_object(obj) {
        ...
        const merged_obj = Object.assign(Object.assign({}, default_obj), properties);
    ...
    function create_sound(sound) {
        ...
        const merged_sound = Object.assign(Object.assign({}, default_sound), sound);
    ...
    function create_sprite(sprite) {
        ...
        const merged_sprite = Object.assign(Object.assign({}, default_sprite), sprite);
    ...
    function create_room(room) {
        ...
        const merged_room = Object.assign(Object.assign({}, default_room), room);
        // Validate cameras
    ...
    function create_layer(layer) {
        ...
        const merged_layer = Object.assign(Object.assign({}, default_layer), layer);
    ...
    function update_camera_position(camera, room) {
        ...
        if (!camera.follow)
            return;
        const inst_id = (_a = room.object_index[camera.follow.target]) === null || _a === void 0 ? void 0 : _a[0];
    ...
    function draw_collision_mask(instance) {
        ...
        const ctx = gm.ctx;
        ctx.save();
        ctx.strokeStyle = ((_a = gm.config) === null || _a === void 0 ? void 0 : _a.debug_color) || "#FF0000";
        ctx.lineWidth = 2;
    ...
    function instances_colliding(a, b) {
        ...
        else if ((a.collision_mask.type === "rect" && b.collision_mask.type === "circle") ||
